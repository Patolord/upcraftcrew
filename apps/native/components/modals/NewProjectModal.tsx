		...
		try {
			await createProject({
				...
				budget: {
					...
					remaining:
						(parseFloat(formData.budgetTotal) || 0) -
						(parseFloat(formData.budgetSpent) || 0),
				},
				teamIds: [],
				tags: formData.tags
					.split(",")
							...
							<View className="flex-row gap-3 mb-4">
								<View className="flex-1">
									...
									<View className="border border-gray-300 rounded-lg">
										<ScrollView>
											{(
												["planning", "in-progress", "completed"] as ProjectStatus[]
											).map((status) => (
												<TouchableOpacity
													key={status}
													onPress={() =>
								...
								<View className="flex-1">
									...
									<View className="border border-gray-300 rounded-lg">
										<ScrollView>
											{(
												["low", "medium", "high", "urgent"] as ProjectPriority[]
											).map((priority) => (
												<TouchableOpacity
													key={priority}
													onPress={() =>
							...
							<View className="flex-row gap-3 mb-4">
								<View className="flex-1">
									...
									<TextInput
										...
										onChangeText={(text) =>
											setFormData({ ...formData, budgetTotal: text })
										}
									/>
								</View>
								<View className="flex-1">
									...
									<TextInput
										...
										onChangeText={(text) =>
											setFormData({ ...formData, budgetSpent: text })
										}
									/>
								</View>
							</View>
