      ...
      <ScrollView className="flex-1 bg-white">
        <View className="flex-1 p-6 justify-center min-h-screen">
          ...
          <View className="items-center mb-12">
            ...
            <Text className="text-3xl font-bold text-gray-800 mb-2">Bem-vindo de volta!</Text>
          ...
          <View className="space-y-4">
            ...
            <TouchableOpacity className="self-end">
              <Text className="text-orange-500 font-medium">Esqueceu a senha?</Text>
            </TouchableOpacity>
            ...
            <View className="flex-row justify-center mt-6">
              ...
              <TouchableOpacity onPress={() => router.push("/(auth)/register")}>
                <Text className="text-orange-500 font-semibold">Cadastre-se</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
