...
export default function SchedulePage() {
	...
	const [_viewMode, _setViewMode] = useState<"month" | "list">("list");
	...
	const getEventTypeColor = (type: string) => {
		switch (type) {
			case "meeting":
				return { bg: "bg-blue-100", text: "text-blue-700", icon: "people" };
			case "deadline":
				return { bg: "bg-red-100", text: "text-red-700", icon: "flag" };
			case "task":
				return {
					bg: "bg-green-100",
					text: "text-green-700",
			...
			case "reminder":
				return { bg: "bg-yellow-100", text: "text-yellow-700", icon: "alarm" };
			case "milestone":
				return { bg: "bg-purple-100", text: "text-purple-700", icon: "trophy" };
			default:
				return { bg: "bg-gray-100", text: "text-gray-700", icon: "calendar" };
		}
	};
