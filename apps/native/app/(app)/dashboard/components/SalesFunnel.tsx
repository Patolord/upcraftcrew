		...
		<View className="space-y-4">
			...
			<View className="rounded-lg bg-white p-4 shadow">
				...
				<Text className="text-gray-600 text-sm">
					Visualize e gerencie suas oportunidades de vendas em cada etapa do
					funil
				</Text>
			</View>
					...
					return (
						...
						>
							...
							>
								...
								<Text className="mb-3 text-gray-600 text-xs">
									{stage.description}
								</Text>
			...
			<View className="rounded-lg bg-white p-4 shadow">
				...
				<View className="flex-row flex-wrap gap-3">
					<View className="min-w-[45%] flex-1 rounded-lg bg-blue-50 p-3">
						...
						<Text className="mt-1 font-bold text-2xl text-blue-600">
							{leads.length}
						</Text>
					</View>
							...
							<View className="flex-row items-center justify-between border-gray-200 border-b p-4">
								<View className="flex-row items-center gap-2">
									<Ionicons
										...
										size={24}
										color={
											stages.find((s) => s.id === selectedStage)?.color ||
											"#FF5722"
										}
									/>
								...
								<View className="mb-4 flex-row gap-3">
									...
									<View className="flex-1">
										...
										<TextInput
											...
											onChangeText={(text) =>
												setFormData({ ...formData, probability: text })
											}
											placeholder="Ex: 50"
											keyboardType="numeric"
										/>
