import type { IChatMessageItem } from "./ChatMessageItem";
...
export const ChatItem = ({
	...
	return (
		...
		>
			<img
				src={image}
				className="bg-base-200 mask mask-squircle size-11 p-0.5"
				alt="avatar"
			/>
			<div className="grow">
				...
				<div className="flex justify-between gap-3">
					...
					{unreadCount && unreadCount != 0 && (
						<div className="badge badge-xs badge-success px-1 py-1.5 text-xs">
							{unreadCount}
						</div>
					)}
				</div>
