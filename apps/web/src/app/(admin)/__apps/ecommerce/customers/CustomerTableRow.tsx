			...
			<tr className="hover:bg-base-200/40 cursor-pointer *:text-nowrap">
				...
				<td>
					<div className="flex items-center space-x-3 truncate">
						<img
							alt="Product"
							className="mask mask-squircle bg-base-200 size-10"
							src={image}
						/>
						<div>
							<p className="font-medium">{name}</p>
							<p className="text-base-content/80 text-xs capitalize">
								{gender}
							</p>
						</div>
					</div>
				...
				<td>
					<div className="inline-flex w-fit">
						...
						<button
							...
							onClick={() =>
								document
									.querySelector<HTMLDialogElement>("#apps-customer-delete")
									?.showModal()
							}
						>
