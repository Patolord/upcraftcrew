		...
		<>
				...
				<div className="card-body p-0">
					<div className="flex items-center justify-between px-5 pt-5">
						...
						<div className="inline-flex items-center gap-3">
							...
							<div className="dropdown dropdown-bottom dropdown-end">
								...
								<div
									tabIndex={0}
									className="dropdown-content bg-base-100 rounded-box z-1 w-52 shadow"
								>
					...
					<div className="flex items-center justify-between p-6">
						...
						<span className="text-base-content/80 hidden text-sm lg:inline">
							Showing{" "}
							<span className="text-base-content font-medium">1 to 20</span> of
							457 items
						</span>
						<div className="inline-flex items-center gap-1">
							...
							<button className="btn btn-ghost btn-circle sm:btn-sm btn-xs">
								2
							</button>
							<button className="btn btn-ghost btn-circle sm:btn-sm btn-xs">
								3
			...
			<dialog id="apps-shop-delete" className="modal">
				<div className="modal-box">
					...
					<p className="py-4">
						{" "}
						You are about to delete this shop. Would you like to proceed further
						?
					</p>
