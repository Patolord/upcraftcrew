					...
					<div className="mt-6 grid gap-6 md:grid-cols-3">
						<div className="card group bg-base-100 card-border cursor-pointer transition-all">
							<div className="card-body">
								...
								<p className="text-base-content/80 mt-1 line-clamp-2 text-sm text-ellipsis">
									Generate compelling blog topics that captivate your audience
									and enhance SEO.
								</p>
						...
						<div className="card group bg-base-100 card-border cursor-pointer transition-all">
							<div className="card-body">
								...
								<p className="text-base-content/80 mt-1 line-clamp-2 text-sm text-ellipsis">
									Create high-converting email copy that boosts engagement and
						...
						<div className="card group bg-base-100 card-border cursor-pointer transition-all">
							<div className="card-body">
								...
								<p className="text-base-content/80 mt-1 line-clamp-2 text-sm text-ellipsis">
									Generate catchy captions designed to maximize engagement
