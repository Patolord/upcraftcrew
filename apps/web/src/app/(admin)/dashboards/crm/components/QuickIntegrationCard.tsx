import {
	type IQuickIntegrationItem,
	QuickIntegrationItem,
} from "./QuickIntegrationItem";
...
const quickIntegrationItems: IQuickIntegrationItem[] = [
	{
		...
		description:
			"Salesforce provides customer relationship management software and application focused on sales",
		isConnected: false,
	},
	...
	},
	{
		...
		description:
			"Notion is a freemium productivity and note-taking web application developed by Notion Lab Inc.",
		isConnected: true,
	},
	{
		name: "Hubspot",
		...
		description:
			"Hubspot is a CRM platform with all the software, integrations and resources you need to connect",
		isConnected: true,
	},
];
