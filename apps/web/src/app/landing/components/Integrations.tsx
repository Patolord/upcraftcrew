...
const data = [
	{
		title: "HubSpot",
		description:
			"Sync customer data and track interactions effortlessly to improve sales and support",
		category: "CRM",
	...
	},
	{
		title: "Shopify",
		description:
			"Automatically update inventory, process orders, and send customer notifications",
		category: "E-commerce",
	...
	},
	{
		title: "Zapier",
		description:
			"Connect with 5,000+ apps to automate repetitive tasks and streamline workflows effortlessly",
		category: "Automation",
	...
	},
	{
		title: "Stripe",
		description:
			"Automate invoicing, payments, and subscription billing with seamless Stripe integration",
		category: "Payment",
	...
	},
	{
		title: "Slack",
		description:
			"Send instant updates to your team, keeping everyone aligned without switching apps",
	...
	},
	{
		title: "Google Drive",
		description:
			"Automatically store and organize important documents, ensuring easy access whenever needed",
		category: "Storage",
		...
		<div className="group/section container overflow-hidden py-8 md:py-12 lg:py-16 2xl:py-28">
			...
			<div className="mt-2 flex justify-center text-center">
				<p className="text-base-content/80 max-w-lg">
					Our platform integrates with the tools you already use, making
					automation smooth and effortless
				</p>
			</div>
			<motion.div
