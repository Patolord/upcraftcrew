const testimonials = [
	...
	},
	{
		...
		name: "Alex Rodriguez",
		comments:
			"Outstanding development experience. Clear communication across time zones, reliable delivery, and the final product was exactly what we needed.",
		...
		>
			...
			<div className="mt-2 flex justify-center text-center">
				<p className="text-base-content/80 max-w-lg">
					See how companies across the globe have scaled their digital presence
					with our bespoke web development solutions
				</p>
			</div>
				...
				<div className="grid grid-cols-2 gap-y-16">
					{stats.map((stat, index) => (
						<div className="text-center" key={index}>
							<div
								className={`bg-base-200 inline-block rounded-full p-3 ${stat.iconClass}`}
							>
				...
				<div className="">
					...
					<div className="mt-12 grid gap-6 max-sm:gap-16 sm:grid-cols-2">
						{testimonials.map((testimonial, index) => (
							<div
								key={index}
								className="bg-base-100 card group relative p-1 shadow"
							>
								<img
								...
								<div className="bg-neutral/4 rounded-box relative p-4 text-center transition-all">
									...
									<p className="text-base-content/80 text-sm leading-none">
