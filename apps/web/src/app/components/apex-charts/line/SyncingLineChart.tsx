	...
	series: [
		{
			...
			name: "Orders",
			data: [
				112, 108, 137, 172, 184, 190, 198, 192, 145, 130, 121, 145, 134, 128,
				80,
			],
		},
	],
	...
	series: [
		{
			...
			name: "Revenue",
			data: [
				11326.56, 12121.92, 21411.73, 28822.04, 18217.84, 18331.2, 18117,
				18958.08, 14685.6, 19505.2, 19390.25, 24960.3, 19194.16, 18012.16, 7988,
			],
		},
	],
};
	...
	series: [
		{
			...
			name: "Average",
			data: [
				101.13, 112.24, 156.29, 167.57, 99.01, 96.48, 91.5, 98.74, 101.28,
				150.04, 160.25, 172.14, 143.24, 140.72, 99.85,
			],
		},
	],
};
