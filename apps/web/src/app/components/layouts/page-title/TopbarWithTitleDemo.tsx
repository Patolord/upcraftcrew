		...
		<div className="w-full">
			<div className="bg-base-100 border-base-200 flex h-15 items-center justify-between border-b px-4">
				...
				<div className="flex items-center">
					<button
						className="btn btn-circle btn-ghost btn-sm me-1"
						aria-label="Search"
					>
					...
					<button
						className="btn btn-circle btn-ghost btn-sm me-3"
						aria-label="Apps"
					>
			...
			<div className="flex items-center justify-between gap-3 px-4 py-3">
				<div className="flex items-center gap-3">
					<p className="text-base-content font-medium sm:text-lg">
						Team Performance
					</p>
					<hr className="border-base-200 h-5 w-px border-e max-sm:hidden" />
					<p className="text-base-content/60 text-sm font-medium max-sm:hidden">
						Workspace ID: #TEAM-9271
					</p>
				</div>
				...
				<div className="flex items-center gap-4">
					<div className="flex items-center gap-0.5">
						...
						<button className="btn btn-ghost btn-sm max-sm:hidden">
							Month
						</button>
						<button className="btn btn-ghost btn-sm max-md:hidden">
							Quarter
						</button>
					</div>
				</div>
