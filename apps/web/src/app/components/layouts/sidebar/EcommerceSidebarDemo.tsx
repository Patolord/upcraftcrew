	...
	return (
		<div className="flex h-full w-full flex-col py-3">
			<div className="flex min-h-10 items-center justify-between gap-3 px-5">
				...
				<div className="flex items-center gap-2">
					...
					<div className="dropdown dropdown-bottom dropdown-end">
						...
						<div
							tabIndex={0}
							className="dropdown-content bg-base-100 rounded-box mt-4 w-44 shadow"
						>
			...
			<div className="border-base-200 rounded-box relative mx-3 mt-3 border p-3">
				...
				<progress
					className="progress progress-warning h-1 align-super"
					max="100"
					value="70"
				></progress>
				...
				<button
					className="btn btn-soft btn-xs btn-circle absolute end-2 top-2"
					aria-label="Close"
				>
