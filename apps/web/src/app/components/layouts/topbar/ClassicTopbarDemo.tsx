		...
		<div className="flex h-full w-full items-center justify-between px-4">
			<div className="flex items-center gap-3">
				...
				<div className="btn btn-outline border-base-300 btn-sm max-sm:btn-square w-56 gap-2 sm:justify-start">
					...
					<p className="text-base-content/60 text-sm font-normal max-sm:hidden">
						Search or jump to...
					</p>
				</div>
			</div>
			<div className="flex items-center">
				<button
					className="btn btn-square btn-ghost btn-sm me-3"
				...
				<div className="dropdown dropdown-bottom dropdown-center me-3">
					...
					<div
						tabIndex={0}
						className="dropdown-content bg-base-100 rounded-box mt-2 w-40 shadow"
					>
