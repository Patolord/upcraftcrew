...
export const BasicNotificationDemo = () => {
	...
	return (
		<div className="dropdown dropdown-bottom sm:dropdown-end dropdown-center">
			...
			<div
				tabIndex={0}
				className="dropdown-content bg-base-100 rounded-box mt-3 w-84 p-2 pt-3 shadow"
			>
				...
				<div className="mt-2 space-y-0.5">
					<div className="rounded-box hover:bg-base-200 flex cursor-pointer items-center gap-3 px-2 py-1 transition-all">
						...
						<p className="grow text-sm leading-tight">
							...
							<span className="text-error">return</span> for item
							<span className="text-base-content/60 float-end ms-2 text-xs">
								Now
							</span>
						</p>
					</div>
					<div className="rounded-box hover:bg-base-200 flex cursor-pointer items-center gap-3 px-2 py-1 transition-all">
						...
						/>
						<p className="grow text-sm leading-tight">
							A new <span className="underline">review</span> has been submitted
							for product
							<span className="text-base-content/60 float-end ms-2 text-xs">
								15 min ago
							</span>
				...
				<div className="mt-2 space-y-0.5">
					...
					<div className="rounded-box hover:bg-base-200 flex cursor-pointer items-center gap-3 px-2 py-1 transition-all">
						...
						<p className="grow text-sm leading-tight">
							Product{" "}
							<span className="border-base-300 border-b border-dashed">
								#ABC123
							</span>{" "}
