	...
	useEffect(() => {
		import("quill").then(({ default: Quill }) => {
			...
			quillInstance.current.setContents([
				...
				{
					insert:
						"Your command center to manage users, track activity, and build smarter workflows.\n\n",
				},
				{
				...
				{
					insert:
						"Built with Tailwind and DaisyUI — clean design, smooth UX, and powerful components.\n\n",
				},
				{
					insert: "✏️ Tip: ",
				...
				{
					insert:
						"You can edit this content directly or replace it with your own HTML-rich text.\n",
				},
			]);
		});
	}, []);
