		...
		<div className="group max-w-md">
			...
			<div className="mt-2 space-y-1">
				...
				<div className="text-base-content/60 group-has-[[data-pass-r2][data-pass-r3]]:text-success flex items-center gap-2 text-sm transition-all duration-300">
					...
					<span>
						Both{" "}
						<span className="group-has-[[data-pass-r3]]:text-success">
							uppercase
						</span>{" "}
						and{" "}
						<span className="group-has-[[data-pass-r2]]:text-success">
							lowercase
						</span>{" "}
						letters
					</span>
				...
				<div className="text-base-content/60 group-has-[[data-pass-r4][data-pass-r5]]:text-success flex items-center gap-2 text-sm transition-all duration-300">
					...
					<span>
						Includes a{" "}
						<span className="group-has-[[data-pass-r4]]:text-success">
							number
						</span>{" "}
						and a{" "}
						<span className="group-has-[[data-pass-r5]]:text-success">
							symbol
						</span>
					</span>
				</div>
