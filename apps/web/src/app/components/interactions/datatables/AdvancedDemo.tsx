...
import { getTableData, type ITableData } from "./helper";
		...
		<div>
			<div className="border-base-200 flex items-center justify-between border-b border-dashed px-5 py-5">
				...
				<div className="flex items-center gap-2">
					<div className="dropdown dropdown-bottom dropdown-end">
						...
						<div
							tabIndex={0}
							className="dropdown-content bg-base-100 rounded-box w-44 shadow"
						>
											...
											{cell.column.id == "actions" ? (
												<div className="flex items-center gap-1.5">
													<button
														...
														onClick={() =>
															alert(`View #${cell.row.original.id}`)
														}
														aria-label="Show"
													>
													...
													<button
														...
														onClick={() =>
															alert(`Delete #${cell.row.original.id}`)
														}
														aria-label="Delete"
													>
			...
			<div className="border-base-200 flex flex-wrap items-center justify-between gap-3 border-t border-dashed p-5">
				...
				<p className="text-base-content/70 text-sm max-md:hidden">
					...
					out of{" "}
					<span className="text-base-content font-medium">{rowCount}</span>
				</p>
				<div className="join">
					<button
