	...
	return (
		<div className="card bg-primary/10 max-w-2xl grow">
			<div className="flex items-center gap-2 px-4 py-1.5">
				...
				<p className="text-primary grow text-xs">
					This tool lets you choose and prompt different models.
				</p>
				<button
					className="btn btn-xs btn-circle btn-ghost hover:bg-primary/20 border-0"
					aria-label="Close"
				>
