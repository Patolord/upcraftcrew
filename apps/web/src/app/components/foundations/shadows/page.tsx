...
const insetShadowVariants = [
	...
	{
		name: "inset-shadow-primary",
		class: "inset-shadow-sm inset-shadow-primary/15",
	},
	{
		name: "inset-shadow-secondary",
		class: "inset-shadow-sm inset-shadow-secondary/15",
	},
	{
		name: "inset-shadow-success",
		class: "inset-shadow-sm inset-shadow-success/15",
	},
	{
		name: "inset-shadow-error",
		class: "inset-shadow-sm inset-shadow-error/15",
	},
];
...
const textShadowVariants = [
	...
	{
		name: "text-shadow-primary",
		class: "text-shadow-lg text-shadow-primary/20 text-primary",
	},
	{
		name: "text-shadow-secondary",
		class: "text-shadow-lg text-shadow-secondary/20 text-secondary",
	},
	{
		name: "text-shadow-success",
		class: "text-shadow-lg text-shadow-success/20 text-success",
	},
	{
		name: "text-shadow-error",
		class: "text-shadow-lg text-shadow-error/20 text-error",
	},
];
		...
		<div>
			...
			<div className="mt-6 space-y-6">
				<div className="card card-border bg-base-200/20">
					<div className="bg-base-200/40 rounded-t-box px-5 py-3 font-medium">
						Box Shadow
					</div>
				...
				<div className="card card-border">
					<div className="bg-base-200/30 rounded-t-box px-5 py-3 font-medium">
						Inset Shadow
					</div>
					<div className="grid grid-cols-2 gap-4 p-4 sm:gap-8 sm:p-6 lg:grid-cols-4">
				...
				<div className="card card-border">
					...
					<div className="flex flex-col gap-3 p-4 sm:p-6">
						{textShadowVariants.map((shadow, index) => (
							<p
								key={index}
								className={`font-semibold capitalize sm:text-lg md:text-xl ${shadow.class}`}
							>
								{shadow.name}
							</p>
						))}
