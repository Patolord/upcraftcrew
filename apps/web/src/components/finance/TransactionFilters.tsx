	...
	return (
		<div className="flex flex-wrap gap-2">
			<select
				...
				value={typeFilter}
				onChange={(e) =>
					onTypeFilterChange(e.target.value as TransactionType | "all")
				}
			>
			...
			<select
				...
				onChange={(e) =>
					onCategoryFilterChange(e.target.value as TransactionCategory | "all")
				}
			>
			...
			<select
				...
				value={statusFilter}
				onChange={(e) =>
					onStatusFilterChange(e.target.value as "all" | "completed" | "pending")
				}
			>
