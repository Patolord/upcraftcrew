...
export function NewBudgetModal({ isOpen, onClose, budgetToEdit }: NewBudgetModalProps) {
	...
	const [formData, setFormData] = useState({
		...
		status: (budgetToEdit?.status || "draft") as "draft" | "sent" | "approved" | "rejected" | "expired",
					...
					<div className="grid grid-cols-2 md:grid-cols-4 gap-6">
						...
						<div className="form-control">
							...
							<select
								...
								onChange={(e) => setFormData({ ...formData, currency: e.target.value as typeof formData.currency })}
								required
							>
